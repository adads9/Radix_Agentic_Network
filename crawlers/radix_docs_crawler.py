...
from chromadb_client import init_collection
from crawl4ai.markdown_generation_strategy import DefaultMarkdownGenerator

load_dotenv()

# Initialize OpenAI client
openai_client = AsyncAzureOpenAI(api_key=os.getenv("API_KEY"))
...
def chunk_text(text: str, chunk_size: int = 5000) -> List[str]:
    """Split text into chunks, with regards to Paragraphs and codeblocks."""
    chunks = []
    start = 0
